<script>
	import mockup from '../../images/p5-CSS-Layout-mockup.jpg';
	import HighLightWrap from '../../components/HighLightWrap.svelte';
	import { CodePen } from 'sveltekit-embed';

	import mockupDivided from '../../images/p5-CSS-Layout-mockup-divided.jpg';
	import purHTMLex from '../../images/p5-html-without-css.jpg';
	import nav from '../../images/p5-nav.png';
	import fourCols from '../../images/p5-four-cols.jpg';
	import {
		ex1,
		ex2,
		ex3,
		...
		ex22,
		ex23
	} from '../2024-06-css-layout/sourceExamples.js';
...
.color-palette .raisin-black {
  background: #1E1E24;
  color: white;
}
.color-palette .penn-red {
  background: #92140C;
  color: white;
}
.color-palette .floral-white {
  background: #FFF8F0;
  color: black;
}
